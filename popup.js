 ...
 * @property {boolean} [kagiNewsEnabled]
 * @property {string[]} [kagiNewsCategories]
 * @property {boolean} [redirectToEnabled]
...
const kagiNewsToggle = /** @type {StashInput} */ (document.getElementById('kagiNewsToggle'));
const kagiNewsToggleRow = /** @type {HTMLElement} */ (document.getElementById('kagiNewsToggleRow'));
const redirectToToggle = /** @type {StashInput} */ (document.getElementById('redirectToToggle'));
const redirectToToggleRow = /** @type {HTMLElement} */ (document.getElementById('redirectToToggleRow'));
const newsCats = /** @type {HTMLElement} */ (document.getElementById('newsCats'));
const newsCatsPills = /** @type {HTMLElement} */ (document.getElementById('newsCatsPills'));
...
if (localStorage.getItem('show-redirect-bing') === 'true') {
    ...
    /** @type {HTMLElement} */ (document.querySelector('.footer-section')).classList.add('visible');
}
...
function updateSections() {
    ...
    if (!takeoverOn) {
        ...
        kagiNewsToggle.checked = kagiNewsToggle._real ?? false;
        redirectToToggle.checked = redirectToToggle._real ?? false;
...
// ── Init ──
chrome.storage.sync.get(['tabTakeoverEnabled', 'blockFocusEnabled', 'smallWebEnabled', 'directMode', 'bingRedirectEnabled', 'kagiNewsEnabled', 'kagiNewsCategories', 'redirectToEnabled', 'selectedCategories', 'selectedFeeds', 'customUrl'], (/** @type {Settings} */ result) => {
